...
\begin{enumerate}
  ...
  \item Generates up to $k=5$ OSM walking-route candidates for the OSM trace setting, or up to $k=10$ OSM driving candidates for the Porto setting.
