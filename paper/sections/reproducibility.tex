...
This writes paired-bootstrap and ablation summaries under \texttt{data/}. The no-temporal trajectory-derived vehicle profile ablation requires rerunning the updated Porto evaluator; it is not backfilled into earlier artifacts.
